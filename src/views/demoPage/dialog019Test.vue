                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="业务所属" prop="field131">
                                <el-input-search
                                  @returnRow="
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field237.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="总分标识" prop="field237">
                                <remote-dict
                                  ref="formModel_field237"
                                  :params="formModelControl.field237.params"
                                  :disabled="formModelControl.field237.disabled"
                                  v-model="formModelData.field237"
                                  placeholder="请选择总分标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field244.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field244">
                                <remote-dict
                                  ref="formModel_field244"
                                  :params="formModelControl.field244.params"
                                  :disabled="formModelControl.field244.disabled"
                                  v-model="formModelData.field244"
                                  placeholder="请选择启用标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
