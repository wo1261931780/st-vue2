                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field205.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field205"
                                  :controls="false"
                                  placeholder="请选择即将完成处理时长"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field205.disabled"
                                ></el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                          </el-row>
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field209.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field209"
                                  :controls="false"
                                  placeholder="请选择时长比例系数"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field209.disabled"
                                >
                                </el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field211.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-time-picker
                                  v-model="formModelData.field211"
                                  format="HH:mm:ss"
                                  ...
                                  :style="{ width: '100%' }"
                                  placeholder="请选择我行下班时间"
                                  clearable
                                  :disabled="formModelControl.field211.disabled"
                                >
                                </el-time-picker>
                              </el-form-item-ex>
                            </el-col>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field213.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input
                                  v-model="formModelData.field213"
                                  placeholder="请选择文档保存路径"
                                  show-word-limit
                                  :disabled="formModelControl.field213.disabled"
                                  clearable
                                  :style="{ width: '100%' }"
                                >
                                </el-input>
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field216.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field216"
                                  :controls="false"
                                  placeholder="请选择超时领用周期倍数"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field216.disabled"
                                ></el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                          </el-row>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field218.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="人均权重" prop="field218">
                                <el-input-number-ex
                                  v-model="formModelData.field218"
                                  :controls="false"
                                  placeholder="请选择人均权重"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field218.disabled"
                                >
                                </el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field220.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field220"
                                  :controls="false"
                                  placeholder="请选择分派任务加权笔数"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field220.disabled"
                                ></el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                          </el-row>
