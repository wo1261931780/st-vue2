                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="交易编码" prop="field160">
                                <el-input-search
                                  @returnRow="
                                    biz.field160ReturnRowHandler ||
                                      biz.emptyFn('field160ReturnRowHandler')
                                  "
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field173.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <remote-dict
                                  ref="formModel_field173"
                                  :params="formModelControl.field173.params"
                                  :disabled="formModelControl.field173.disabled"
                                  v-model="formModelData.field173"
                                  placeholder="请选择境内外标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                              </el-form-item-ex>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field175.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <remote-dict
                                  ref="formModel_field175"
                                  :params="formModelControl.field175.params"
                                  :disabled="formModelControl.field175.disabled"
                                  v-model="formModelData.field175"
                                  placeholder="请选择不计算清算截止"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                              </el-form-item-ex>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field177.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <remote-dict
                                  ref="formModel_field177"
                                  :params="formModelControl.field177.params"
                                  :disabled="formModelControl.field177.disabled"
                                  v-model="formModelData.field177"
                                  placeholder="请选择不计算当天完成"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                              </el-form-item-ex>
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field184.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field184">
                                <remote-dict
                                  ref="formModel_field184"
                                  :params="formModelControl.field184.params"
                                  :disabled="formModelControl.field184.disabled"
                                  v-model="formModelData.field184"
                                  placeholder="请选择启用标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
