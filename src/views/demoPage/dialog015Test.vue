                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="员工号" prop="field131">
                                <el-input-search
                                  @returnRow="
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="交易类型" prop="field160">
                                <el-input-search
                                  @returnRow="
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="交易节点" prop="field205">
                                <el-input-number-ex
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="偏好类型" prop="field209">
                                <remote-dict
                                  ref="formModel_field209"
                                  :params="formModelControl.field209.params"
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field211">
                                <remote-dict
                                  ref="formModel_field211"
                                  :params="formModelControl.field211.params"
