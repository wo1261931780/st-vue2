                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="队列名称" prop="field131">
                                <remote-dict
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field133.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-search
                                  @returnRow="
                                    biz.field133ReturnRowHandler ||
                                      biz.emptyFn('field133ReturnRowHandler')
                                  "
                                  v-model="formModelData.field133"
                                  ...
                                  :default-param="3"
                                  query-name="1"
                                  :disabled="formModelControl.field133.disabled"
                                  clearable
                                  :style="{ width: '100%' }"
                                >
                                </el-input-search>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field135.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <remote-dict
                                  ref="formModel_field135"
                                  :params="formModelControl.field135.params"
                                  :disabled="formModelControl.field135.disabled"
                                  v-model="formModelData.field135"
                                  placeholder="请选择交易节点编码"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                              </el-form-item-ex>
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field138.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="组织名称" prop="field138">
                                <el-input-search
                                  @returnRow="
                                    biz.field138ReturnRowHandler ||
                                      biz.emptyFn('field138ReturnRowHandler')
                                  "
                                  v-model="formModelData.field138"
                                  placeholder="请选择组织名称"
                                  show-word-limit
                                  :disabled="formModelControl.field138.disabled"
                                  clearable
                                  :style="{ width: '100%' }"
                                >
                                </el-input-search>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field140.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="阈值" prop="field140">
                                <el-input
                                  v-model="formModelData.field140"
                                  placeholder="请选择阈值"
                                  show-word-limit
                                  :disabled="formModelControl.field140.disabled"
                                  clearable
                                  :style="{ width: '100%' }"
                                >
                                </el-input>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field142.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field142">
                                <remote-dict
                                  ref="formModel_field142"
                                  :params="formModelControl.field142.params"
                                  :disabled="formModelControl.field142.disabled"
                                  v-model="formModelData.field142"
                                  placeholder="请选择启用标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field145.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="参数落地" prop="field145">
                                <el-input
                                  v-model="formModelData.field145"
                                  placeholder="请选择参数落地"
                                  show-word-limit
                                  :disabled="formModelControl.field145.disabled"
                                  clearable
                                  :style="{ width: '100%' }"
                                >
                                </el-input>
