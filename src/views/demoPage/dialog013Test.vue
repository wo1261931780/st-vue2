                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field198.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="组织名称" prop="field198">
                                <el-input-search
                                  @returnRow="
                                    biz.field198ReturnRowHandler ||
                                      biz.emptyFn('field198ReturnRowHandler')
                                  "
                                  v-model="formModelData.field198"
                                  placeholder="请选择组织名称"
                                  show-word-limit
                                  :disabled="formModelControl.field198.disabled"
                                  clearable
                                  :style="{ width: '100%' }"
                                >
                                </el-input-search>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field200.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field200">
                                <remote-dict
                                  ref="formModel_field200"
                                  :params="formModelControl.field200.params"
                                  :disabled="formModelControl.field200.disabled"
                                  v-model="formModelData.field200"
                                  placeholder="请选择启用标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
