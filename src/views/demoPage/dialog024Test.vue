                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="用户工号" prop="field131">
                                <el-input-search
                                  @returnRow="
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="组织名称" prop="field160">
                                <el-input-search
                                  @returnRow="
                          ...
                          <el-row :gutter="15">
                            ...
                            >
                              ...
                              >
                                <el-input-search
                                  @returnRow="
                                    biz.field248ReturnRowHandler ||
                                      biz.emptyFn('field248ReturnRowHandler')
                                  "
                                  v-model="formModelData.field248"
                                  placeholder="请选择二级组织名称"
                                  show-word-limit
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="归属关系" prop="field285">
                                <remote-dict
                                  ref="formModel_field285"
                                  :params="formModelControl.field285.params"
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field289">
                                <remote-dict
                                  ref="formModel_field289"
                                  :params="formModelControl.field289.params"
