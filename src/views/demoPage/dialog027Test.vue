                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field316.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <remote-dict
                                  ref="formModel_field316"
                                  :params="formModelControl.field316.params"
                                  :disabled="formModelControl.field316.disabled"
                                  v-model="formModelData.field316"
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field321.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <remote-dict
                                  ref="formModel_field321"
                                  :params="formModelControl.field321.params"
                                  :disabled="formModelControl.field321.disabled"
                                  v-model="formModelData.field321"
                                  placeholder="请选择是否参与智能排序"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                              </el-form-item-ex>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field323.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field323">
                                <remote-dict
                                  ref="formModel_field323"
                                  :params="formModelControl.field323.params"
                                  :disabled="formModelControl.field323.disabled"
                                  v-model="formModelData.field323"
                                  placeholder="请选择启用标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
