                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="用户号" prop="field131">
                                <el-input-number-ex
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="用户名称" prop="field160">
                                <el-input
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="偏好开关" prop="field248">
                                <remote-dict
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field285.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field285"
                                  :controls="false"
                                  placeholder="请选择当月日均业务量"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field285.disabled"
                                ></el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                          </el-row>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field289.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field289"
                                  :controls="false"
                                  placeholder="请选择业务均衡优先原则计分"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field289.disabled"
                                ></el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                          </el-row>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field311.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field311"
                                  :controls="false"
                                  placeholder="请选择有权限的可分派交易总数"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field311.disabled"
                                ></el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                          </el-row>
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field301.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field301"
                                  :controls="false"
                                  placeholder="请选择权限少优先原则计分"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field301.disabled"
                                ></el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                          </el-row>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field303.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <remote-dict
                                  ref="formModel_field303"
                                  :params="formModelControl.field303.params"
                                  :disabled="formModelControl.field303.disabled"
                                  v-model="formModelData.field303"
                                  placeholder="请选择智能分派开关"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                              </el-form-item-ex>
