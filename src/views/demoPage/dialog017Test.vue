                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="组织名称" prop="field131">
                                <el-input-search
                                  @returnRow="
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="时间类型" prop="field160">
                                <remote-dict
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="时间值" prop="field205">
                                <el-input
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field237">
                                <remote-dict
