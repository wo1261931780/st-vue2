                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                          ...
                          <el-row :gutter="15">
                            ...
                            >
                              ...
                              >
                                <el-input-search
                                  @returnRow="
                                    biz.field131ReturnRowHandler ||
                                      biz.emptyFn('field131ReturnRowHandler')
                                  "
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="分值" prop="field160">
                                <remote-dict
                                  ref="formModel_field160"
                                  :params="formModelControl.field160.params"
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field162.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field162">
                                <remote-dict
                                  ref="formModel_field162"
                                  :params="formModelControl.field162.params"
                                  :disabled="formModelControl.field162.disabled"
                                  v-model="formModelData.field162"
                                  placeholder="请选择启用标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
