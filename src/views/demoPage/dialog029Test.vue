                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="客户名称" prop="field160">
                                <el-input-search
                                  @returnRow="
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field328.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <remote-dict
                                  ref="formModel_field328"
                                  :params="formModelControl.field328.params"
                                  :disabled="formModelControl.field328.disabled"
                                  v-model="formModelData.field328"
                                  placeholder="请选择节点（总/分/不区分）"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                              </el-form-item-ex>
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field331.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field331">
                                <remote-dict
                                  ref="formModel_field331"
                                  :params="formModelControl.field331.params"
                                  :disabled="formModelControl.field331.disabled"
                                  v-model="formModelData.field331"
                                  placeholder="请选择启用标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field333.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="组织名称" prop="field333">
                                <el-input-search
                                  @returnRow="
                                    biz.field333ReturnRowHandler ||
                                      biz.emptyFn('field333ReturnRowHandler')
                                  "
                                  v-model="formModelData.field333"
                                  placeholder="请选择组织名称"
                                  show-word-limit
                                  :disabled="formModelControl.field333.disabled"
                                  clearable
                                  :style="{ width: '100%' }"
                                >
                                </el-input-search>
