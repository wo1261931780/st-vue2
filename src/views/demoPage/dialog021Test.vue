                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="交易类型" prop="field131">
                                <el-input-search
                                  @returnRow="
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              ...
                              :offset="0"
                            >
                              <el-form-item-ex label="交易节点" prop="field160">
                                <remote-dict
                    ...
                    <el-col :span="24" style="width:100%;">
                      <el-row :gutter="15">
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field254.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field254"
                                  :controls="false"
                                  placeholder="请选择当前节点时长"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field254.disabled"
                                >
                                </el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field256.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex
                              ...
                              >
                                <el-input-number-ex
                                  v-model="formModelData.field256"
                                  :controls="false"
                                  placeholder="请选择当前节点时长中位数"
                                  :step="1"
                                  :precision="2"
                                  :disabled="formModelControl.field256.disabled"
                                ></el-input-number-ex>
                              </el-form-item-ex>
                            </el-col>
                          </el-row>
                        ...
                        <el-col :span="24" style="width:33%;">
                          <el-row :gutter="15">
                            <el-col
                              v-if="formModelControl.field263.isShow"
                              :span="24"
                              :offset="0"
                            >
                              <el-form-item-ex label="启用标识" prop="field263">
                                <remote-dict
                                  ref="formModel_field263"
                                  :params="formModelControl.field263.params"
                                  :disabled="formModelControl.field263.disabled"
                                  v-model="formModelData.field263"
                                  placeholder="请选择启用标识"
                                  clearable
                                  :style="{ width: '100%' }"
                                ></remote-dict>
